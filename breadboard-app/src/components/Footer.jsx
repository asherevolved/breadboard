                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 mb-16">
                    ...
                    <div className="md:col-span-3">
                        ...
                        <div className="mt-8 pt-6 border-t border-white/5 space-y-3">
                            <a href="mailto:info@breadboard.in" className="inline-flex items-center text-sm font-semibold text-primary hover:text-primary-dark transition-colors group">
                                info@breadboard.in
